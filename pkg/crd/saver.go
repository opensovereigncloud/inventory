...
func NewSaverSvc(kubeconfig string, namespace string) (*SaverSvc, error) {
...
func (s *SaverSvc) Save(inv *apiv1alpha1.Inventory) error {
...
func (s *SaverSvc) Patch(name string, patch interface{}) error {
